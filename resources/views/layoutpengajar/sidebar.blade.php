    ...
    <div class="sidebar small">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
              <a href="{{ url('/dashboardpengajar')}}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{ url('/pengajardatapriwa')}}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{ url('/pengajarpenilaian')}}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{ url('/pengajarabsensi')}}" class="nav-link">
            ...
            <li class="nav-header">Menu Pengajar</li>
            <li class="nav-item">

                ...
                <div class="col-6 col-md-6 col-sm-6">
                    <div class="card card-info">
                        ...
                        <div class="card-header">
                            <h4 class="card-title">{{ $admin->nama }}</h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div style="text-align: center">
                                <a href="/admin/{{ $admin->id }}/edit" class="btn btn-primary d-inline my-5">Ubah Data</a>
                                <form action="{{ $admin->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf

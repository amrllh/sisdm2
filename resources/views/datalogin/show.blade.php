...
@section('title', 'Detail Data Login')
                ...
                <div class="card card-success card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div style="text-align: center">
                            <button type="button" class="btn btn-info d-inline my-5" data-toggle="modal" data-target="#modal-lg">Ubah Data</button>
                            @if( $user->role != 1)
                            <button type="button" class="btn btn-danger d-inline my-5" data-toggle="modal" data-target="#modal-default">Hapus</button>
                            @endif
                            <button onclick="location.href='/datalogin'" type="button" class="btn btn-secondary d-inline my-5">Kembali</button>
                        </div>
                    </div>
                </div>
                {{-- card --}}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Data pengguna <strong>{{ $user->name }}</strong> akan dihapus, Anda yakin?&hellip;</p>
                </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Formulir Ubah Data Login</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="/datalogin/{{ $user->id }}">
                        @method('patch')
                        @csrf    
                            ...
                            <div class="row">
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="Masukkan Email Baru" value="{{ $user->email }}" disabled>
